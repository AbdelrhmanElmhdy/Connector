...
class AuthServiceTests: XCTestCase {
    ...
    func createSUT() -> RealAuthService {
        let authService = RealAuthService(userDefaultsManager: userDefaultsManagerMock,
    ...
    func testSuccessfulLogin() {
        ...
        userServiceMock.fetchRemoteUserWithIdCompletionClosure = { _, completion in
            completion(self.stubsFactory.createUserStub(), nil)
        }
    ...
    func testStateAfterSuccessfulLogin() {
        ...
        userServiceMock.fetchRemoteUserWithIdCompletionClosure = { _, completion in
            let user = self.stubsFactory.createUserStub()
    ...
    func testSuccessfulSignup() {
        ...
        // When
        sut.signup(user: stubsFactory.createUserStub(), password: "t")
            .sink { completion in
                switch completion {
                case .failure:
