...
class ChatMessageServiceMock: ChatMessageService {
    ...
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeCallsCount = 0
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeCalled: Bool {
        return createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeCallsCount > 0
    }
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReceivedArguments: (senderId: String, roomId: String, repliedAtMessageId: String?, type: Message.MessageType, text: String?, mediaOrFileURL: URL?, location: Location?, contact: Contact?, interactionType: Message.InteractionType?)?
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReceivedInvocations: [(senderId: String, roomId: String, repliedAtMessageId: String?, type: Message.MessageType, text: String?, mediaOrFileURL: URL?, location: Location?, contact: Contact?, interactionType: Message.InteractionType?)] = []
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReturnValue: Message!
    var createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeClosure: ((String, String, String?, Message.MessageType, String?, URL?, Location?, Contact?, Message.InteractionType?) -> Message)?

    func createMessage(senderId: String, roomId: String, repliedAtMessageId: String?, type: Message.MessageType, text: String?, mediaOrFileURL: URL?, location: Location?, contact: Contact?, interactionType: Message.InteractionType?) -> Message {
        createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeCallsCount += 1
        createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReceivedArguments = (senderId: senderId, roomId: roomId, repliedAtMessageId: repliedAtMessageId, type: type, text: text, mediaOrFileURL: mediaOrFileURL, location: location, contact: contact, interactionType: interactionType)
        createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReceivedInvocations.append((senderId: senderId, roomId: roomId, repliedAtMessageId: repliedAtMessageId, type: type, text: text, mediaOrFileURL: mediaOrFileURL, location: location, contact: contact, interactionType: interactionType))
        if let createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeClosure = createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeClosure {
            return createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeClosure(senderId, roomId, repliedAtMessageId, type, text, mediaOrFileURL, location, contact, interactionType)
        } else {
            return createMessageSenderIdRoomIdRepliedAtMessageIdTypeTextMediaOrFileURLLocationContactInteractionTypeReturnValue
        }
    }
