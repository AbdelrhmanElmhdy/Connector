...
class UserServiceTests: XCTestCase {
  ...
  func createSUT() -> MainUserService {
      MainUserService(coreDataManager: coreDataManagerMock,
  ...
  func testUsersFetch() {
      // Given
      let sut = createSUT()
      let stubbedUsers = stubsFactory.makeUserStubs(3)
  ...
  func testUserDeletion() {
      // Given
      let sut = createSUT()
      let toBeDeletedUser = stubsFactory.makeUserStub()
