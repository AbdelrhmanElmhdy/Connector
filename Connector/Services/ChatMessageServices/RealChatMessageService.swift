...
class RealChatMessageService: ChatMessageService {
    ...
    init(coreDataManager: CoreDataManager, chatMessageNetworkService: ChatMessageNetworkService, userService: UserService, authService: AuthService) {
