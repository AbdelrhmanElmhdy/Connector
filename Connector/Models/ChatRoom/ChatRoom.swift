...
public class ChatRoom: NSManagedObject, Codable {
	...
	var partnersIDs: [String] {
		guard let currentUser = currentUser, !participantsIDs.isEmpty else { return [] }
	...
	var chatName: String {
		guard isChatBinary else { return groupChatName ?? .ui.defaultGroupChatName }
	...
	func setLastMessageLabel(message: Message?) {
		...
		case .image:
			lastMessageLabel = String.ui.photo + " " + lastMessageText
		case .video:
			lastMessageLabel = String.ui.video + " " + lastMessageText
		case .voiceNote:
			lastMessageLabel = String.ui.voiceNote
		case .file:
			lastMessageLabel = String.ui.file + " " + lastMessageText
		case .location:
			lastMessageLabel = String.ui.location
		case .contact:
			lastMessageLabel = String.ui.contact
		}
	}
	...
	public func encode(to encoder: Encoder) throws {
		...
		try container.encode(messages ?? Set<Message>(), forKey: .messages)
