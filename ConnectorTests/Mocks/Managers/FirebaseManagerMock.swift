...
class FirebaseManagerMock: FirebaseManager {
    ...
    var createUserEmailPasswordCompletionReceivedArguments: (email: String, password: String, completion: (AuthDataResult?, FirebaseAuthError?) -> Void)?
    var createUserEmailPasswordCompletionReceivedInvocations: [(email: String, password: String, completion: (AuthDataResult?, FirebaseAuthError?) -> Void)] = []
    var createUserEmailPasswordCompletionClosure: ((String, String, @escaping (AuthDataResult?, FirebaseAuthError?) -> Void) -> Void)?
    ...
    var signInEmailPasswordCompletionReceivedArguments: (email: String, password: String, completion: (AuthDataResult?, FirebaseAuthError?) -> Void)?
    var signInEmailPasswordCompletionReceivedInvocations: [(email: String, password: String, completion: (AuthDataResult?, FirebaseAuthError?) -> Void)] = []
    var signInEmailPasswordCompletionClosure: ((String, String, @escaping (AuthDataResult?, FirebaseAuthError?) -> Void) -> Void)?
